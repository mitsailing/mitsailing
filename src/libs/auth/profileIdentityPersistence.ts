...
export type ProfileDetailsInput = ProfileIdentityInput & ProfileContactInput;
...
/**
 * Validates profile identity fields for a specific user id.
 *
 * @param props - Affiliation/name/MIT ID fields and target user id
 * @returns Validated identity or a domain error
 */
...
/**
 * Normalizes and validates profile contact fields.
 *
 * @param input - Phone and emergency contact fields
 * @returns Normalized contact or a domain error
 */
...
/**
 * Persists validated profile identity (and optional contact) for a user.
 *
 * @param props - Validated identity, optional contact, and target user id
 * @returns Duplicate MIT ID error, or null on success
 */
