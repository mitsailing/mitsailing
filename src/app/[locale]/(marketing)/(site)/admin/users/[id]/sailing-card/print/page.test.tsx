...
import AdminUserSailingCardPrintPage from './page';
...
describe('AdminUserSailingCardPrintPage', () => {
  it('redirects regular print to the inline PDF route', async () => {
    mocks.requirePermission.mockResolvedValue({ user: { id: 'admin-1' } });

    await expect(
      AdminUserSailingCardPrintPage({
