...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
  ...
  return { title: t('meta_title_mitna') };
}

export default async function MitnaLandingPage(props: PageProps) {
  const { locale } = await props.params;
