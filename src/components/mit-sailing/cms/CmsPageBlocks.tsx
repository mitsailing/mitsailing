...
const blockLinkClassName =
  'inline-flex items-center gap-1 rounded-sm font-semibold text-mit-red no-underline hover:underline dark:text-mit-red-ink focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none';
