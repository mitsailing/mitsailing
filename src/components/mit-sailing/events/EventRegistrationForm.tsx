...
export function eventRegistrationFormLabels(
  ...
  return {
    ...
    errorMessages: {
      ...
      waitlist_required: t('registration_error_waitlist_required'),
      unknown: t('registration_error_unknown'),
    } satisfies Record<EventRegistrationMutationCode, string>,
    feesHeading: t('section_fees'),
    learnToSailRankingHeading: t('learn_to_sail_ranking_heading'),
    learnToSailRankingRule: t('learn_to_sail_request_rule'),
    learnToSailWaitlistNumber: t('learn_to_sail_waitlist_number'),
    learnToSailRequestNote: t('learn_to_sail_request_review_note'),
