...
function configuredHeaderMenuItems(props: {
  ...
  return props.headerMenuItems && props.headerMenuItems.length > 0
    ? props.headerMenuItems
    : defaultHeaderMenuItems(props.t);
}
...
function configuredMobileUtilityItems(props: {
  ...
  return props.mobileUtilityItems && props.mobileUtilityItems.length > 0
    ? props.mobileUtilityItems
    : defaultMobileUtilityItems(props.t);
}
