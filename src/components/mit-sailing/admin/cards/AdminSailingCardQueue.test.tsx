  ...
  useTranslations: () => (key: string, values?: Record<string, unknown>) => {
    ...
    const messages: Record<string, string> = {
      ...
      error_mit_recreation_required:
        'Verify MIT Recreation before issuing full sailing.',
...
describe('AdminSailingCardQueue', () => {
  it('lists pending users with card request details and suggested number', () => {
    ...
    expect(screen.getByText('Full sailing')).toBeInTheDocument();
  ...
  it('flags full sailing requests that need mit recreation verification', () => {
    render(
      <AdminSailingCardQueue
        canAssignCards
        locale="en"
