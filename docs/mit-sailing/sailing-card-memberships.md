...
|---|---|---|
| `normal` | Full sailing membership | General MITNA sailing membership with Pavilion sailing, classes, ratings, Charles River racing, and Mashnee access when the sailor has the required rating or approval. Mashnee is the 48-foot sailboat kept in Boston Harbor for blue-water sailing. Included for MIT students and MIT Recreation members. |
...
## Free full sailing membership

Always present included full sailing membership eligibility in this order:
...
If a user does not have MIT Recreation membership yet, they may still request full sailing membership. Staff should not issue the sailing card number until MIT Recreation membership is active.

Full sailing membership includes ordinary Pavilion racing access. Pavilion-racing cards exist for people who do not have full sailing membership and only need Charles River racing or race-related classes at the Sailing Pavilion.
...
MIT students do not pay for sailing cards. MIT Recreation members receive full sailing membership without a paid Pavilion-racing or Thursday-team-racing card.
